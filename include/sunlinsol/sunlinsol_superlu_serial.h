...
/* Assume SuperLU serial library was built with compatible index type */
...
#define SUNSLU_ORDERING_DEFAULT  COLAMD     /* COLAMD */
...
struct _SUNLinearSolverContent_SuperLU_Serial {
  int          last_flag;
  int          first_factorize;
...
typedef struct _SUNLinearSolverContent_SuperLU_Serial *SUNLinearSolverContent_SuperLU_Serial;
...
SUNDIALS_EXPORT SUNLinearSolver SUNLinSol_SuperLU(N_Vector y,
                                                    SUNMatrix A,
                                                    SUNContext sunctx);
SUNDIALS_EXPORT int SUNLinSol_SuperLUSetOrdering(SUNLinearSolver S, int ordering_choice);
...
SUNDIALS_EXPORT int SUNLinSolSolve_SuperLU(SUNLinearSolver S, SUNMatrix A, N_Vector x, N_Vector b, realtype tol);
SUNDIALS_EXPORT sunindextype SUNLinSolLastFlag_SuperLU(SUNLinearSolver S);
SUNDIALS_EXPORT int SUNLinSolSpace_SuperLU(SUNLinearSolver S, long int *lenrwLS, long int *leniwLS);
