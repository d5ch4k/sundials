...
sundials_option(BUILD_SUNLINSOL_SUPERLU_SERIAL BOOL "Build the SUNLINSOL_SUPERLU_SERIAL module (requires SUPERLU_SERIAL)" OFF
                DEPENDS_ON ENABLE_SUPERLU_SERIAL SUPERLU_SERIAL_WORKS
                ADVANCED)
list(APPEND SUNDIALS_BUILD_LIST "BUILD_SUNLINSOL_SUPERLU_SERIAL")

sundials_option(BUILD_SUNLINSOL_EIGENSPARSE BOOL "Build the SUNLINSOL_EIGENSPARSE module (requires Eigen3)" ON
        DEPENDS_ON ENABLE_EIGEN_SPARSE_LINEAR_SOLVER
        ADVANCED)
list(APPEND SUNDIALS_BUILD_LIST "BUILD_SUNLINSOL_EIGENSPARSE")
