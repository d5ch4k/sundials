...
#include <sunmatrix/sunmatrix_eigensparse.h>    /* access to sparse SUNMatrix        */
#include <sunlinsol/sunlinsol_eigen_sparse.h> /* access to Eigen Sparse linear solver */
...
int main()
{
 ...
 J = SUNEigenSparseMatrix(NEQ, NEQ, nnz, CSC_MAT, sunctx);
 if(check_retval((void *)J, "SUNSparseMatrix", 0)) return(1);

 /* Create SuperLU solver object */
 LS = SUNLinSol_EigenSparse(y, J, sunctx);
 ...
 */
 ...
 IJth(J,1,7) = 1.0;
 */
 tripletList.emplace_back(0,0, - 0.1238 + 0.004731*x3);
 tripletList.emplace_back(0,1, - 0.001637 - 0.3578*x3);
 tripletList.emplace_back(0,2, 0.004731*x1 - 0.3578*x2);
 tripletList.emplace_back(0,3, - 0.9338);
 tripletList.emplace_back(0,6, 1.0);
 ...
 */
 ...
 IJth(J,2,7) = -1.0;
 */
 tripletList.emplace_back(1,0, 0.2638 + 0.2238*x3);
 tripletList.emplace_back(1,1, - 0.07745 + 0.7623*x3);
 tripletList.emplace_back(1,2, 0.2238*x1 + 0.7623*x2);
 tripletList.emplace_back(1,3, - 0.6734);
 tripletList.emplace_back(1,6, -1.0);
 ...
 */
 ...
 IJth(J,3,8) = x6;
 */
 tripletList.emplace_back(2,0, 0.35789);
 tripletList.emplace_back(2,1, 0.004731);
 tripletList.emplace_back(2,5, x8);
 tripletList.emplace_back(2,7, x6);
 ...
 */
 ...
 IJth(J,4,2) = 0.2238;
 */
 tripletList.emplace_back(3,0, - 0.7623);
 tripletList.emplace_back(3,1, 0.2238);
 ...
 */
 ...
 IJth(J,5,2) = 2.0*x2;
 */
 tripletList.emplace_back(4,0, 2.0*x1);
 tripletList.emplace_back(4,1, 2.0*x2);
 ...
 */
 ...
 IJth(J,6,4) = 2.0*x4;
 */
 tripletList.emplace_back(5,2, 2.0*x3);
 tripletList.emplace_back(5,3, 2.0*x4);
 ...
 */
 ...
 IJth(J,7,6) = 2.0*x6;
 */
 tripletList.emplace_back(6,4, 2.0*x5);
 tripletList.emplace_back(6,5, 2.0*x6);
 ...
 */
 ...
 IJth(J,8,8) = 2.0*x8;
 */
 tripletList.emplace_back(7,6, 2.0*x7);
 tripletList.emplace_back(7,7, 2.0*x8);
 ...
 */
 for(int i=0;i<8;i++) {
   tripletList.emplace_back(8+i,i,-1.0);
   tripletList.emplace_back(8+i,8+i, 1.0);
 }
 ...
 */
 for(int i=0;i<8;i++) {
   tripletList.emplace_back(16+i,i, 1.0);
   tripletList.emplace_back(16+i,16+i, 1.0);
 }
 ...
 */
 ...
 Eigen::SparseMatrix<double, Eigen::ColMajor, int64_t> JJ(24,24);


 JJ.setFromTriplets(tripletList.begin(), tripletList.end());

// auto os = JJ.outerSize();
// auto is = JJ.innerSize();
// std::copy(JJ.outerIndexPtr(), JJ.outerIndexPtr()+JJ.outerSize()+1, colptrs);
// std::copy(JJ.innerIndexPtr(), JJ.innerIndexPtr()+JJ.nonZeros(), rowvals);
// std::copy(JJ.valuePtr(), JJ.valuePtr()+JJ.nonZeros(), data);
//
// Eigen::Matrix<double,24,24> JJD, JMD;
// JJD=JJ;
//
// Eigen::Map<Eigen::SparseMatrix<double, Eigen::ColMajor, int64_t>> JM(24,24,56,colptrs,rowvals,data);
//
// JMD = JM;
 //double err = (JJ-JM).norm();

 SUNMatEigenCSCCopy_EigenSparse(JJ, J);
 //double err2 = err*err;
