 ...
 * -----------------------------------------------------------------
 * This is the testing routine to check the SUNLinSol SuperLU
...
int main(int argc, char *argv[])
{
  ...
  printf("\nSuperLU linear solver test: size %ld, type %i\n\n",
         (long int) N, mattype);
  ...
  fails += Test_SUNLinSolGetID(LS, SUNLINEARSOLVER_SUPERLU, 0);
